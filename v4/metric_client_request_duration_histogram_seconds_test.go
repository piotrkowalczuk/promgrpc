...
func TestNewClientRequestDurationStatsHandler_30s(t *testing.T) {
	...
	expected := `
        ...
        grpc_client_request_duration_histogram_seconds_bucket{grpc_client_user_agent="fake-user-agent",grpc_code="OK",grpc_is_fail_fast="true",grpc_method="Method",grpc_service="service",le="29.999999999999947"} 3
