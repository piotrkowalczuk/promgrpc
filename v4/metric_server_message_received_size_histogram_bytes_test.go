...
func TestNewServerMessageReceivedSizeStatsHandler(t *testing.T) {
	...
	expected := `
        ...
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="59.496662720538"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="110.6204023400455"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="205.67327400112185"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="382.40229418354824"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="710.9893850187037"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="1321.921738698142"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="2457.810369695954"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="4569.734831151281"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="8496.3741241032"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="15797.05955028983"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="29371.010126245237"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="54608.65885133497"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="101532.27991558747"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="188775.99416828004"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="350985.6767113877"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="652577.3883449133"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="1.213318024168964e+06"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="2.2558866642728257e+06"} 3
        grpc_server_message_received_size_histogram_bytes_bucket{grpc_client_user_agent="fake-user-agent",grpc_method="Method",grpc_service="service",le="4.1943039999999953e+06"} 3
